...
const category = getCategoryBySlug("business-tools")!;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${siteConfig.url}/business-tools/` },
  openGraph: meta.openGraph,
};

export default function CategoryPageRoute() {
  const related = categories.filter((c) => c.slug !== "business-tools").slice(0, 4);
  return (
    <CategoryPage
      category={category}
      tools={tools}
