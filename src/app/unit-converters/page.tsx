...
const category = getCategoryBySlug("unit-converters")!;
const tools = getToolsByCategory("unit-converters");
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${siteConfig.url}/unit-converters/` },
  openGraph: meta.openGraph,
};

export default function CategoryPageRoute() {
  const related = categories.filter((c) => c.slug !== "unit-converters").slice(0, 4);
  return (
    <CategoryPage
      category={category}
      tools={tools}
