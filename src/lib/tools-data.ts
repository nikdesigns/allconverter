...
export const tools: Tool[] = [
  ...
  // ===========================
  {
    ...
    metaTitle: "PDF Compressor — Compress PDF Online Free, Up to 90% Smaller | AllConverter.tools",
    metaDescription: "Compress PDF online free — reduce PDF file size by up to 90% in seconds. No sign-up, no uploads, 100% browser-based. Ideal for email, web & storage.",
    category: "pdf-tools",
    icon: "FileDown",
    tags: ["pdf", "compress", "reduce size", "optimize"],
    keywords: [
      "compress pdf", "pdf compressor", "reduce pdf size", "compress pdf online",
      "compress pdf free", "compress pdf online free", "reduce pdf file size",
      "pdf size reducer", "smaller pdf", "pdf optimizer", "shrink pdf",
      "compress pdf without losing quality", "pdf file size reducer online",
      "free pdf compressor", "pdf compression tool",
    ],
    isPopular: true,
    isFeatured: true,
  ...
  },
  {
    ...
    metaTitle: "PDF Merger — Merge PDF Files Online Free, No Sign-Up | AllConverter.tools",
    metaDescription: "Merge PDF files online free — combine unlimited PDFs into one in seconds. Drag to reorder pages. No sign-up, no uploads, 100% browser-based.",
    category: "pdf-tools",
    icon: "FilePlus2",
    tags: ["pdf", "merge", "combine", "join"],
    keywords: [
      "merge pdf", "pdf merger", "combine pdf", "join pdf files", "merge pdf online",
      "combine pdf files online", "pdf combiner", "merge pdf free", "merge pdf online free",
      "how to merge pdf", "merge multiple pdf", "combine pdf pages", "free pdf merger",
      "pdf join online", "merge pdfs into one",
    ],
    isPopular: true,
  ...
  },
  {
    ...
    metaTitle: "PDF Splitter — Split PDF by Page Range Free Online | AllConverter.tools",
    metaDescription: "Split PDF online free — extract pages, split by range, or separate every page. No sign-up, no file upload needed. 100% browser-based PDF splitter.",
    category: "pdf-tools",
    icon: "ScissorsLineDashed",
    tags: ["pdf", "split", "extract", "pages"],
    keywords: [
      "split pdf", "pdf splitter", "extract pdf pages", "split pdf online",
      "split pdf online free", "pdf page extractor", "separate pdf pages",
      "split pdf by page", "pdf split tool", "cut pdf pages", "pdf extract pages",
      "split pdf into multiple files", "free pdf splitter", "divide pdf",
    ],
  ...
  },
  {
    ...
    metaTitle: "PDF to JPG Converter — Free Online, Every Page in Seconds | AllConverter.tools",
    metaDescription: "Convert PDF to JPG online free — every page becomes a high-res image instantly. No sign-up, no uploads. Choose 72, 144, or 216 DPI. Works in any browser.",
    category: "pdf-tools",
    icon: "FileImage",
    tags: ["pdf", "jpg", "image", "convert"],
    keywords: [
      "pdf to jpg", "pdf to jpeg", "convert pdf to jpg", "pdf to image",
      "pdf to jpg online", "pdf to jpg free", "pdf to jpg converter",
      "pdf page to jpg", "pdf to jpg online free", "pdf to jpg converter online free",
      "export pdf as jpg", "pdf to image converter", "convert pdf pages to images",
      "pdf to png", "pdf to picture",
    ],
  ...
  },
  {
    ...
    metaTitle: "JPG to PDF Converter — Free Online, No Sign-Up | AllConverter.tools",
    metaDescription: "Convert JPG to PDF online free — turn photos and images into a PDF in seconds. Multiple images per PDF, A4 or fit-to-image page size. No upload needed.",
    category: "pdf-tools",
    icon: "FilePlus",
    tags: ["jpg", "pdf", "image", "convert"],
    keywords: [
      "jpg to pdf", "jpeg to pdf", "convert jpg to pdf", "image to pdf",
      "jpg to pdf converter", "photos to pdf", "jpg to pdf online",
      "jpg to pdf online free", "png to pdf", "picture to pdf",
      "images to pdf converter", "convert photos to pdf", "free jpg to pdf",
      "multiple jpg to pdf", "jpg to pdf converter online free",
    ],
  ...
  // ===========================
  {
    slug: "image-enhancer",
    name: "Image Enhancer",
    tagline: "Enhance photos with smart AI-powered adjustments",
    description:
      "Enhance any photo with intelligent auto-enhancement, brightness, contrast, saturation, color temperature, sharpening, and vignette. Before/after split-view preview included.",
    metaTitle: "Image Enhancer — Free Online Photo Enhancement Tool | AllConverter.tools",
    metaDescription: "Enhance photos free online — auto-enhance, adjust brightness, contrast, saturation, sharpness & temperature. Before/after preview. No sign-up, 100% browser-based.",
    category: "image-tools",
    icon: "Sparkles",
    tags: ["image enhancer", "photo editor", "enhance photo", "brightness", "contrast", "sharpen"],
    keywords: [
      "image enhancer", "photo enhancer", "enhance image online",
      "photo enhancement online free", "image editor online",
      "enhance photo quality", "auto enhance photo", "brighten image online",
      "sharpen image online", "image quality enhancer", "photo enhancer free",
      "online photo editor", "improve photo quality", "enhance picture online",
    ],
    isNew: true,
    isFeatured: true,
    isTrending: true,
    ...
    useCases: [
      "Fix under/over-exposed photos automatically",
      "Add professional photo presets (Portrait, Vivid, Landscape)",
      "Enhance product photos for e-commerce listings",
      "Sharpen blurry or soft-focus images",
    ],
    howTo: [
      { title: "Upload image", description: "Drop any JPG, PNG, WebP, or AVIF photo." },
      { title: "Auto Enhance", description: "Click Auto Enhance to apply smart histogram-based corrections instantly." },
      { title: "Fine-tune", description: "Use sliders to adjust brightness, contrast, saturation, temperature, sharpness, and vignette." },
      { title: "Preview & download", description: "Drag the split-view divider to compare before/after, then download the enhanced JPG." },
    ],
    faqs: [
      { question: "Is my image uploaded to any server?", answer: "No. All processing happens entirely in your browser using the Canvas API. Your images never leave your device." },
      { question: "What does Auto Enhance do?", answer: "It analyses the image histogram to detect brightness and contrast issues, then automatically applies corrections — similar to 'Auto Levels' in Photoshop." },
      { question: "Why is Sharpness not visible in the preview?", answer: "Sharpening uses a pixel-level convolution filter which is applied during export for performance. The before/after preview uses fast CSS filters for real-time response." },
    ],
  },
  {
    ...
    metaTitle: "Image Compressor — Compress JPG, PNG, WebP Free Online | AllConverter.tools",
    metaDescription: "Compress images online free — reduce JPG, PNG, WebP, GIF file size up to 80% with no visible quality loss. Batch compress, no sign-up, no uploads.",
    category: "image-tools",
    icon: "ImageDown",
    tags: ["image", "compress", "optimize", "jpg", "png", "webp"],
    keywords: [
      "image compressor", "compress image", "compress jpg", "compress png",
      "compress photo", "reduce image size", "image optimizer", "compress image online free",
      "jpeg compressor", "compress images online", "image size reducer",
      "photo compressor", "compress webp", "batch image compressor",
      "reduce photo size", "compress image without losing quality",
      "online image compressor", "png compressor", "jpg compressor online",
    ],
    isPopular: true,
    isFeatured: true,
  ...
  },
  {
    ...
    metaTitle: "Image Resizer — Resize Images Free Online, Any Dimension | AllConverter.tools",
    metaDescription: "Resize images online free — by pixels, percentage, or preset (HD, 4K, social). Maintain aspect ratio. JPG, PNG, WebP supported. No sign-up or upload needed.",
    category: "image-tools",
    icon: "Maximize2",
    tags: ["image", "resize", "dimensions", "crop"],
    keywords: [
      "image resizer", "resize image", "resize image online", "resize photo",
      "image resize free", "resize image online free", "change image size",
      "resize jpg", "resize png", "photo resizer", "resize picture online",
      "image dimensions", "resize image to specific size", "bulk image resizer",
      "resize image without losing quality", "online image resizer",
    ],
    isPopular: true,
  ...
  },
  {
    ...
    metaTitle: "JPG to PNG Converter — Free Online, Lossless | AllConverter.tools",
    metaDescription: "Convert JPG to PNG free online — lossless quality, supports transparency. Batch convert multiple JPEG files instantly. No sign-up, no file upload required.",
    category: "image-tools",
    icon: "RefreshCw",
    tags: ["jpg", "png", "convert", "image"],
    keywords: [
      "jpg to png", "jpeg to png", "convert jpg to png", "jpg to png converter",
      "jpg to png online", "jpg to png online free", "jpeg to png converter",
      "convert jpeg to png", "free jpg to png converter", "batch jpg to png",
      "jpg to png no background", "photo to png", "image to png",
    ],
    isTrending: true,
  ...
  },
  {
    ...
    metaTitle: "PNG to JPG Converter — Free Online, Smaller File Size | AllConverter.tools",
    metaDescription: "Convert PNG to JPG online free — reduce file size with custom quality settings. Batch convert multiple PNGs instantly. No sign-up, no upload, 100% browser-based.",
    category: "image-tools",
    icon: "RefreshCcw",
    tags: ["png", "jpg", "convert", "image"],
    keywords: [
      "png to jpg", "png to jpeg", "convert png to jpg", "png to jpg converter",
      "png to jpg online", "png to jpg online free", "png to jpg free",
      "png to jpeg converter online", "convert png to jpeg", "batch png to jpg",
      "compress png to jpg", "png to jpg no quality loss",
    ],
  ...
  },
  {
    ...
    metaTitle: "PNG to WebP Converter — Free Online, Smaller & Faster | AllConverter.tools",
    metaDescription: "Convert PNG to WebP online free — up to 30% smaller than PNG with same visual quality. Batch convert, no sign-up, 100% browser-based. Ideal for web performance.",
    category: "image-tools",
    icon: "Zap",
    tags: ["png", "webp", "convert", "web"],
    keywords: [
      "png to webp", "convert png to webp", "png to webp converter",
      "png to webp online", "png to webp free", "png to webp online free",
      "batch png to webp", "png webp converter", "image to webp",
      "webp converter", "convert to webp", "webp format converter",
    ],
    isTrending: true,
    relatedTools: ["jpg-to-png", "image-compressor"],
    howTo: [
  ...
  },
  {
    ...
    metaTitle: "Background Remover — Free AI Background Removal Online | AllConverter.tools",
    metaDescription: "Remove image background free online — AI-powered, instant transparent PNG output. Perfect for product photos & profile pics. No sign-up, no file upload.",
    category: "image-tools",
    icon: "Layers",
    tags: ["background", "remove", "transparent", "ai", "png"],
    keywords: [
      "background remover", "remove background", "background eraser",
      "remove background from image", "transparent background", "remove image background",
      "background remover free", "remove background online", "remove background free",
      "ai background remover", "remove background from photo",
      "transparent png", "cut out image background", "photo background remover",
      "remove white background", "product photo background removal",
    ],
    isNew: true,
    isTrending: true,
  ...
  },
  {
    ...
    metaTitle: "SVG to PNG Converter — Free Online, Any Scale | AllConverter.tools",
    metaDescription: "Convert SVG to PNG online free — render vector graphics at 1x, 2x, 3x or 4x scale. Custom size, transparent background. No sign-up, runs in browser.",
    category: "image-tools",
    icon: "Shapes",
    tags: ["svg", "png", "vector", "convert"],
    keywords: [
      "svg to png", "convert svg to png", "svg to png converter",
      "svg to png online", "svg to png free", "svg to png online free",
      "svg converter", "vector to png", "svg to image",
      "svg to png high resolution", "svg to raster", "svg export png",
    ],
  ...
  // ===========================
  {
    ...
    metaTitle: "Word Counter — Free Online Word & Character Count Tool | AllConverter.tools",
    metaDescription: "Count words, characters, sentences & paragraphs online free — real-time results, reading time, keyword density. No sign-up. Works for essays, blogs & tweets.",
    category: "text-tools",
    icon: "Hash",
    tags: ["word count", "character count", "text analysis", "writing"],
    keywords: [
      "word counter", "word count", "character counter", "character count",
      "word count online", "count words online", "word counter online free",
      "words and characters counter", "count characters", "text character counter",
      "online word counter", "essay word counter", "word count checker",
      "count words and characters", "reading time calculator",
    ],
    isPopular: true,
    isFeatured: true,
  ...
  },
  {
    ...
    metaTitle: "Case Converter — Free Online Text Case Changer | AllConverter.tools",
    metaDescription: "Convert text case free online — UPPERCASE, lowercase, Title Case, camelCase, snake_case, kebab-case & more. Instant results, no sign-up required.",
    category: "text-tools",
    icon: "CaseSensitive",
    tags: ["case", "uppercase", "lowercase", "camelcase", "text"],
    keywords: [
      "case converter", "text case converter", "uppercase to lowercase",
      "lowercase to uppercase", "title case converter", "camelcase converter",
      "snake case converter", "kebab case converter", "text case changer",
      "convert text case online", "sentence case converter", "case changer online free",
      "text capitalization tool", "change text case",
    ],
    isPopular: true,
  ...
  },
  {
    ...
    metaTitle: "Lorem Ipsum Generator — Free Placeholder Text Generator | AllConverter.tools",
    metaDescription: "Generate Lorem Ipsum placeholder text free online — paragraphs, sentences, or words. Classic & random modes. Instant copy, no sign-up required.",
    category: "text-tools",
    icon: "AlignLeft",
    tags: ["lorem ipsum", "placeholder", "dummy text", "design"],
    keywords: [
      "lorem ipsum generator", "lorem ipsum", "placeholder text generator",
      "dummy text generator", "lorem ipsum text", "lorem ipsum online",
      "generate lorem ipsum", "random text generator", "filler text generator",
      "lorem ipsum copy paste", "lorem ipsum generator free", "dummy content generator",
      "placeholder text online", "random paragraph generator",
    ],
    relatedTools: ["word-counter", "text-cleaner"],
    howTo: [
  ...
  // ===========================
  {
    ...
    metaTitle: "JSON Formatter & Beautifier — Free Online JSON Validator | AllConverter.tools",
    metaDescription: "Format, beautify & validate JSON online free — syntax highlighting, error detection, minify. No sign-up, no upload. Instant results in any browser.",
    category: "developer-tools",
    icon: "Braces",
    tags: ["json", "format", "validate", "beautify", "developer"],
    keywords: [
      "json formatter", "json beautifier", "json validator", "format json",
      "json formatter online", "json formatter online free", "beautify json",
      "json pretty print", "json lint", "json minifier", "json editor online",
      "validate json", "json formatter and validator", "json viewer",
      "online json formatter", "json syntax checker",
    ],
    isPopular: true,
    isFeatured: true,
  ...
  },
  {
    ...
    metaTitle: "Base64 Encoder & Decoder — Free Online Tool | AllConverter.tools",
    metaDescription: "Encode & decode Base64 online free — text, files, and data URIs. Instant results, no sign-up required. Supports UTF-8, binary, and HTML image embed.",
    category: "developer-tools",
    icon: "Binary",
    tags: ["base64", "encode", "decode", "developer"],
    keywords: [
      "base64 encoder", "base64 decoder", "base64 encode", "base64 decode",
      "base64 encoder online", "base64 decoder online", "encode base64",
      "decode base64", "base64 online", "base64 converter", "base64 to text",
      "text to base64", "base64 encoding tool", "base64 encode online free",
    ],
    isPopular: true,
  ...
  },
  {
    ...
    metaTitle: "URL Encoder & Decoder — Free Online Percent-Encoding Tool | AllConverter.tools",
    metaDescription: "Encode & decode URLs online free — percent-encoding, query parameters, and full URL encoding. Instant results, no sign-up. Essential developer tool.",
    category: "developer-tools",
    icon: "Link",
    tags: ["url", "encode", "decode", "percent-encoding"],
    keywords: [
      "url encoder", "url decoder", "url encode", "url decode",
      "url encoder online", "percent encoding", "url encoding tool",
      "encode url online", "decode url online", "url encoder decoder free",
      "url encode online free", "html url encoder", "query string encoder",
    ],
  ...
  },
  {
    ...
    metaTitle: "UUID Generator — Free Online UUID & GUID Generator v1, v4, v5 | AllConverter.tools",
    metaDescription: "Generate UUIDs & GUIDs free online — v1, v4, v5. Bulk generate unique identifiers for databases and APIs. Instant, no sign-up, 100% browser-based.",
    category: "developer-tools",
    icon: "Fingerprint",
    tags: ["uuid", "guid", "generate", "unique id"],
    keywords: [
      "uuid generator", "guid generator", "uuid generator online",
      "random uuid generator", "uuid v4 generator", "unique id generator",
      "uuid generator free", "generate uuid online", "bulk uuid generator",
      "uuid creator", "guid generator online", "uuid v1 generator",
      "uuid generator javascript", "random guid generator",
    ],
    isTrending: true,
  ...
  },
  {
    ...
    metaTitle: "Regex Tester — Free Online Regular Expression Debugger | AllConverter.tools",
    metaDescription: "Test & debug regular expressions free online — real-time match highlighting, JavaScript & Python flavors. No sign-up, instant results in your browser.",
    category: "developer-tools",
    icon: "ScanSearch",
    tags: ["regex", "regular expression", "pattern", "developer"],
    keywords: [
      "regex tester", "regex tester online", "regular expression tester",
      "regex debugger", "regex checker", "javascript regex tester",
      "python regex tester", "online regex", "regex matcher online",
      "test regex online", "regex validator", "regex pattern tester",
      "regex online free", "regular expression online", "regex tool",
    ],
  ...
  // ===========================
  {
    ...
    metaTitle: "Meta Tag Generator — Free SEO Meta Tags Tool, Open Graph & Twitter Cards | AllConverter.tools",
    metaDescription: "Generate SEO meta tags free online — title, description, keywords, Open Graph & Twitter Card tags. Copy-paste ready HTML. No sign-up, instant results.",
    category: "seo-tools",
    icon: "Tags",
    tags: ["seo", "meta tags", "open graph", "twitter cards"],
    keywords: [
      "meta tag generator", "seo meta tags", "meta tags generator online",
      "open graph generator", "twitter card generator", "meta description generator",
      "html meta tags", "generate meta tags", "meta tag creator", "seo tags generator",
      "og tags generator", "meta keywords generator", "meta tag generator free",
      "website meta tags", "generate seo tags",
    ],
    isPopular: true,
    isFeatured: true,
  ...
  },
  {
    ...
    metaTitle: "Robots.txt Generator — Free Online robots.txt Creator | AllConverter.tools",
    metaDescription: "Generate a robots.txt file free online — control Googlebot, Bingbot & other crawlers. Set allow/disallow rules and sitemap URL. Download instantly, no sign-up.",
    category: "seo-tools",
    icon: "Bot",
    tags: ["robots.txt", "seo", "crawler", "sitemap"],
    keywords: [
      "robots txt generator", "robots.txt generator", "create robots txt",
      "robots txt creator", "robots txt file generator", "seo robots txt",
      "generate robots.txt online", "robots txt maker", "googlebot disallow",
      "search engine crawler", "robots txt free", "robots file generator",
    ],
  ...
  },
  {
    ...
    metaTitle: "Keyword Density Checker — Free SEO Content Analysis Tool | AllConverter.tools",
    metaDescription: "Check keyword density free online — find top keywords, bigrams & trigrams in your content. Instant SEO analysis, no sign-up, works in your browser.",
    category: "seo-tools",
    icon: "BarChart2",
    tags: ["keyword", "density", "seo", "content", "analysis"],
    keywords: [
      "keyword density checker", "keyword density", "keyword density tool",
      "keyword frequency checker", "seo keyword density", "keyword analysis tool",
      "keyword density analyzer", "check keyword density", "content keyword analyzer",
      "seo content analysis", "keyword density calculator", "on-page seo checker",
    ],
  ...
  },
  {
    ...
    metaTitle: "Sitemap Generator — Free XML Sitemap Creator for SEO | AllConverter.tools",
    metaDescription: "Generate an XML sitemap free online — add URLs, set priority & change frequency, download sitemap.xml instantly. No sign-up, no upload required.",
    category: "seo-tools",
    icon: "Map",
    tags: ["sitemap", "xml", "seo", "google"],
    keywords: [
      "sitemap generator", "xml sitemap generator", "sitemap generator free",
      "create sitemap", "sitemap creator", "generate xml sitemap",
      "sitemap xml generator online", "seo sitemap generator", "google sitemap generator",
      "website sitemap generator", "sitemap.xml generator", "free sitemap generator",
    ],
  ...
  // ===========================
  {
    ...
    metaTitle: "BMI Calculator — Free Online Body Mass Index Calculator | AllConverter.tools",
    metaDescription: "Calculate your BMI free online — metric & imperial units, instant results with healthy weight range and BMI category. No sign-up required.",
    category: "calculators",
    icon: "Activity",
    tags: ["bmi", "body mass index", "health", "weight", "calculator"],
    keywords: [
      "bmi calculator", "bmi calculator online", "body mass index calculator",
      "bmi calculator free", "bmi calculator kg cm", "bmi calculator lbs",
      "check bmi online", "bmi check", "calculate bmi", "bmi index calculator",
      "healthy bmi calculator", "bmi chart", "bmi calculator for adults",
      "bmi calculator metric", "bmi calculator imperial",
    ],
    isPopular: true,
    isFeatured: true,
  ...
  },
  {
    ...
    metaTitle: "Age Calculator — Calculate Exact Age from Date of Birth | AllConverter.tools",
    metaDescription: "Calculate your exact age online free — years, months, days, hours & minutes from date of birth. Instant results, no sign-up. Works on any device.",
    category: "calculators",
    icon: "Calendar",
    tags: ["age", "birthday", "date", "calculator"],
    keywords: [
      "age calculator", "age calculator online", "age calculator from date of birth",
      "how old am i calculator", "birthday calculator", "age finder",
      "calculate age online", "exact age calculator", "date of birth age calculator",
      "age calculator free", "dob calculator", "age in days calculator",
      "how old am i", "age from birthday", "years months days calculator",
    ],
    isPopular: true,
  ...
  },
  {
    ...
    metaTitle: "Compound Interest Calculator — Free Investment Growth Tool | AllConverter.tools",
    metaDescription: "Calculate compound interest free online — see investment growth with monthly, quarterly & annual compounding. Instant results, no sign-up required.",
    category: "calculators",
    icon: "TrendingUp",
    tags: ["compound interest", "investment", "savings", "financial"],
    keywords: [
      "compound interest calculator", "compound interest calculator online",
      "compound interest formula", "investment growth calculator",
      "savings calculator", "compound interest monthly", "compound interest annually",
      "compound interest free calculator", "calculate compound interest",
      "interest calculator online", "future value calculator", "investment calculator",
    ],
    isTrending: true,
  ...
  },
  {
    ...
    metaTitle: "Loan EMI Calculator — Free Online Home, Car & Personal Loan Calculator | AllConverter.tools",
    metaDescription: "Calculate loan EMI free online — home loan, car loan, personal loan. See total interest, monthly payment & amortization schedule. Instant, no sign-up.",
    category: "calculators",
    icon: "CreditCard",
    tags: ["loan", "emi", "mortgage", "financial", "calculator"],
    keywords: [
      "loan emi calculator", "emi calculator", "loan calculator",
      "home loan emi calculator", "car loan calculator", "personal loan calculator",
      "emi calculator online", "mortgage calculator", "loan emi calculator online free",
      "monthly payment calculator", "loan interest calculator",
      "amortization calculator", "emi formula calculator",
    ],
    isPopular: true,
  ...
  },
  {
    ...
    metaTitle: "Password Generator — Free Strong & Secure Password Creator | AllConverter.tools",
    metaDescription: "Generate strong random passwords free online — custom length, symbols, numbers, uppercase. 100% browser-based, never stored or sent. Instant, no sign-up.",
    category: "developer-tools",
    icon: "KeyRound",
    tags: ["password", "security", "generate", "random"],
    keywords: [
      "password generator", "strong password generator", "random password generator",
      "secure password generator", "password generator online", "password creator",
      "complex password generator", "generate strong password", "password maker",
      "random password maker", "password generator free", "safe password generator",
      "password generator online free", "create strong password",
    ],
    isPopular: true,
  ...
  // ===========================
  {
    ...
    metaTitle: "Invoice Generator — Free Online Professional Invoice Maker | AllConverter.tools",
    metaDescription: "Create & download professional PDF invoices free online — logo, line items, taxes, payment terms. No sign-up, instant download. Perfect for freelancers & SMBs.",
    category: "business-tools",
    icon: "FileSpreadsheet",
    tags: ["invoice", "billing", "pdf", "business", "freelance"],
    keywords: [
      "invoice generator", "invoice maker", "free invoice generator",
      "invoice generator online", "online invoice maker", "create invoice online",
      "professional invoice generator", "pdf invoice generator", "invoice creator",
      "free invoice maker online", "invoice generator for freelancers",
      "blank invoice template", "generate invoice free", "invoice template online",
    ],
    isNew: true,
    isTrending: true,
  ...
  { slug: "gst-invoice-generator", name: "GST Invoice Generator", tagline: "Create GST-compliant tax invoices with CGST/SGST/IGST", description: "Generate professional GST tax invoices with GSTIN fields, HSN/SAC codes, and automatic CGST/SGST/IGST breakdown. Print or save as PDF.", metaTitle: "GST Invoice Generator — Free GST Tax Invoice Maker Online | AllConverter.tools", metaDescription: "Generate GST invoices free online — GSTIN, HSN/SAC codes, CGST/SGST/IGST auto-calculation. Download as PDF. No sign-up, instant print. Made for India.", category: "business-tools", icon: "ReceiptText", tags: ["gst", "invoice", "tax", "cgst", "sgst", "igst", "india", "billing"], keywords: ["gst invoice generator", "gst bill generator", "gst invoice maker", "gst tax invoice", "gst invoice format", "create gst invoice online", "gst invoice generator free", "gst bill maker", "gst invoice download", "cgst sgst invoice", "igst invoice generator", "gstin invoice", "hsn code invoice", "gst invoice india"], isNew: true, isTrending: true, relatedTools: ["invoice-generator", "gst-calculator", "receipt-generator"], howTo: [{ title: "Enter supplier & buyer details", description: "Add GSTINs, addresses, and contact info." }, { title: "Select supply type", description: "Choose intra-state (CGST+SGST) or inter-state (IGST)." }, { title: "Add line items", description: "Enter HSN/SAC codes, quantities, rates, and GST rates." }, { title: "Print or save", description: "Preview and print/save as PDF." }], faqs: [{ question: "What is a GST invoice?", answer: "A GST tax invoice is a legal document issued by a GST-registered supplier to the buyer, showing GSTIN, HSN codes, and applicable GST components." }] },
  // Quotation Generator
  ...
  // AUDIO TOOLS
  // ===========================
  { slug: "mp3-cutter", name: "MP3 Cutter", tagline: "Trim and cut audio files online", description: "Cut any audio file to the exact segment you need. Set a start and end time, preview the selection, and download the trimmed clip as a WAV file — all in your browser.", metaTitle: "MP3 Cutter — Free Online Audio Trimmer & Cutter | AllConverter.tools", metaDescription: "Cut and trim MP3, WAV, M4A & OGG audio free online — set start/end time, preview, download. 100% browser-based, no sign-up, no file upload to servers.", category: "audio-tools", icon: "Scissors", tags: ["mp3 cutter", "audio trimmer", "cut mp3", "trim audio", "audio editor"], keywords: ["mp3 cutter", "audio cutter", "mp3 trimmer", "cut mp3 online", "trim audio online", "audio trimmer online free", "mp3 cutter online free", "cut audio online", "online mp3 cutter", "mp3 editor online", "audio clip cutter", "trim mp3 online free", "cut wav file online"], isNew: true, isFeatured: true, isPopular: true, relatedTools: ["audio-joiner", "audio-volume-booster"], howTo: [{ title: "Upload file", description: "Drag or select your MP3, WAV, M4A, or OGG file." }, { title: "Set start & end", description: "Drag the sliders or type exact times to mark your clip." }, { title: "Preview", description: "Click Preview to hear the selection before downloading." }, { title: "Download", description: "Click Cut & Download to save the trimmed WAV." }], faqs: [{ question: "What audio formats are supported?", answer: "MP3, WAV, M4A, AAC, OGG, and any format your browser can decode." }, { question: "Why is the output WAV instead of MP3?", answer: "WAV encoding happens in the browser without a library. WAV is lossless and universally supported." }] },
  { slug: "audio-joiner", name: "Audio Joiner", tagline: "Merge multiple audio files into one", description: "Combine two or more audio tracks into a single file. Upload your files, drag to reorder them, and download the merged result.", metaTitle: "Audio Joiner — Free Online MP3 Merger & Audio Combiner | AllConverter.tools", metaDescription: "Join & merge audio files free online — combine MP3, WAV, M4A tracks into one file. Drag to reorder, instant download. No sign-up, browser-based.", category: "audio-tools", icon: "ListMusic", tags: ["audio joiner", "merge audio", "combine mp3", "audio merger", "join audio"], keywords: ["audio joiner", "mp3 joiner", "audio merger", "merge mp3 online", "combine audio files", "join audio online", "audio combiner", "mp3 combiner online free", "merge audio files online", "audio joiner online free", "combine mp3 files", "audio merger online free"], isNew: true, isFeatured: true, relatedTools: ["mp3-cutter", "audio-compressor"], howTo: [{ title: "Add files", description: "Click or drag to add MP3, WAV, M4A, or OGG files." }, { title: "Reorder", description: "Use the arrows to set the join order." }, { title: "Merge", description: "Click Join & Download to download the combined WAV." }], faqs: [{ question: "How many files can I join?", answer: "There's no hard limit — it depends on your browser's available memory." }] },
  ...
  { slug: "mp4-to-mp3", name: "MP4 to MP3", tagline: "Extract audio from MP4 video files", description: "Strip the audio track from any MP4 video and download it as a WAV file. Works entirely in your browser — no server upload needed.", metaTitle: "MP4 to MP3 Converter — Free Online Audio Extractor | AllConverter.tools", metaDescription: "Convert MP4 to MP3 free online — extract audio from any video instantly. Browser-based, no file upload to servers, no sign-up. Download as WAV.", category: "audio-tools", icon: "FileAudio2", tags: ["mp4 to mp3", "extract audio", "video to audio", "mp4 audio", "convert mp4"], keywords: ["mp4 to mp3", "convert mp4 to mp3", "mp4 to mp3 online", "mp4 to mp3 free", "extract audio from mp4", "video to mp3", "mp4 to mp3 converter online free", "mp4 audio extractor", "video to audio converter", "convert mp4 to mp3 online free"], isNew: true, isFeatured: true, isPopular: true, relatedTools: ["video-to-audio", "mp3-to-wav"], howTo: [{ title: "Upload MP4", description: "Drag or select your .mp4 video file." }, { title: "Extract", description: "Click Convert & Download — the audio track is saved as WAV." }], faqs: [{ question: "What video formats are supported?", answer: "Any format your browser supports: MP4, WebM, and sometimes MOV." }] },
  ...
  { slug: "webp-to-jpg", name: "WebP to JPG", tagline: "Convert WebP images to JPG format", description: "Convert WebP images to JPG instantly in your browser. Adjust quality and download individual files or a ZIP.", metaTitle: "WebP to JPG Converter — Free Online, No Upload | AllConverter.tools", metaDescription: "Convert WebP to JPG free online — adjust quality, batch convert multiple files. No sign-up, no server upload, instant browser-based conversion.", category: "image-tools", icon: "Image", tags: ["webp", "jpg", "jpeg", "convert", "image"], keywords: ["webp to jpg", "convert webp to jpg", "webp to jpeg", "webp to jpg online", "webp to jpg free", "webp converter", "webp to jpg converter", "change webp to jpg", "webp to jpg online free", "convert webp image", "webp to jpg without software"], isNew: true, relatedTools: ["webp-to-png", "jpg-to-png", "image-compressor"], howTo: [{ title: "Upload WebP", description: "Drop one or more WebP images." }, { title: "Set quality", description: "Adjust JPG quality (default 90%)." }, { title: "Download", description: "Download the converted JPG files." }], faqs: [] },
  { slug: "webp-to-png", name: "WebP to PNG", tagline: "Convert WebP images to PNG format", description: "Convert WebP images to lossless PNG format in your browser. Supports transparency preservation.", metaTitle: "WebP to PNG Converter — Free Online, Lossless | AllConverter.tools", metaDescription: "Convert WebP to PNG free online — lossless quality, transparency preserved. No sign-up, no server upload, batch convert multiple WebP images instantly.", category: "image-tools", icon: "Image", tags: ["webp", "png", "convert", "image", "lossless"], keywords: ["webp to png", "convert webp to png", "webp to png online", "webp to png free", "webp to lossless png", "webp converter to png", "webp to png online free", "change webp to png", "convert webp image to png", "webp to png with transparency"], isNew: true, relatedTools: ["webp-to-jpg", "png-to-jpg", "svg-to-png"], howTo: [{ title: "Upload WebP", description: "Drop one or more WebP images." }, { title: "Convert", description: "Images are converted to lossless PNG." }, { title: "Download", description: "Download the PNG files." }], faqs: [] },
  { slug: "heic-to-jpg", name: "HEIC to JPG", tagline: "Convert iPhone HEIC photos to JPG", description: "Convert HEIC/HEIF images from iPhone and iPad to universal JPG format, right in your browser.", metaTitle: "HEIC to JPG Converter — Free Online iPhone Photo Converter | AllConverter.tools", metaDescription: "Convert HEIC to JPG free online — iPhone & iPad HEIC/HEIF photos to universal JPG. No app install, no sign-up, 100% browser-based. Instant download.", category: "image-tools", icon: "Smartphone", tags: ["heic", "heif", "jpg", "iphone", "convert"], keywords: ["heic to jpg", "heic to jpeg", "convert heic to jpg", "heic converter", "iphone heic to jpg", "heic to jpg online", "heic to jpg free", "heic file converter", "heif to jpg", "iphone photo converter", "heic converter online free", "convert heic", "heic to jpg without software"], isNew: true, isFeatured: true, relatedTools: ["heic-to-png", "webp-to-jpg", "image-compressor"], howTo: [{ title: "Upload HEIC", description: "Drop HEIC files from your iPhone or Mac." }, { title: "Convert", description: "Images are decoded and converted to JPG." }, { title: "Download", description: "Download the universal JPG files." }], faqs: [{ question: "Why can't I open HEIC files on Windows?", answer: "HEIC is Apple's format. This tool converts them to JPG which works on any device and platform." }] },
  { slug: "heic-to-png", name: "HEIC to PNG", tagline: "Convert iPhone HEIC photos to PNG", description: "Convert HEIC/HEIF images from iPhone and iPad to lossless PNG format, preserving full quality.", metaTitle: "HEIC to PNG Converter — Free Online, No Install | AllConverter.tools", metaDescription: "Convert HEIC to PNG free online — iPhone HEIC/HEIF to lossless PNG with full transparency. No app needed, no sign-up, instant browser-based conversion.", category: "image-tools", icon: "Smartphone", tags: ["heic", "heif", "png", "iphone", "convert"], keywords: ["heic to png", "convert heic to png", "heic to png online", "heic to png free", "iphone heic to png", "heif to png", "heic converter to png", "heic to png without software", "heic file to png", "iphone photo to png"], isNew: true, relatedTools: ["heic-to-jpg", "webp-to-png", "png-to-jpg"], howTo: [{ title: "Upload HEIC", description: "Drop HEIC files from your iPhone or Mac." }, { title: "Convert", description: "Images are decoded and converted to PNG." }, { title: "Download", description: "Download the lossless PNG files." }], faqs: [] },
